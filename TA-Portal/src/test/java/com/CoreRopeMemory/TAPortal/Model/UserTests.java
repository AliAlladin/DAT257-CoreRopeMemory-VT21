...
public class UserTests {
    ...
    void populateWorkshifts(){
        ...
        workshifts.add(new WorkShift(LocalDate.of(2021,5,6), LocalTime.of(17,0), LocalTime.of(19,0), "Lectures and exercise sessions"));
    }
    ...
    public void salaryTest1(){
        assertTrue(user.getSalary(workshifts) == 975);
    }

    @Test
    public void salaryTest2(){
        user.setHasMaster(true);
        assertTrue(user.getSalary(workshifts) == 1136);
    }
